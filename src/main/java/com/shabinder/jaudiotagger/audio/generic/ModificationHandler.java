...
import com.shabinder.jaudiotagger.audio.exceptions.ModifyVetoException;
...
public class ModificationHandler implements AudioFileModificationListener
{
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileModificationListener#fileModified(com.shabinder.jaudiotagger.audio.AudioFile,
     *File)
     */
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileModificationListener#fileOperationFinished(File)
     */
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileModificationListener#fileWillBeModified(com.shabinder.jaudiotagger.audio.AudioFile,
     *boolean)
     */
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileModificationListener#vetoThrown(com.shabinder.jaudiotagger.audio.generic.AudioFileModificationListener,
     *com.shabinder.jaudiotagger.audio.AudioFile,
     *com.shabinder.jaudiotagger.audio.exceptions.ModifyVetoException)
     */
