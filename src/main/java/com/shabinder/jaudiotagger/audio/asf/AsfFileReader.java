 ...
 */
package com.shabinder.jaudiotagger.audio.asf;

import com.shabinder.jaudiotagger.audio.AudioFile;
import com.shabinder.jaudiotagger.audio.asf.data.AsfHeader;
import com.shabinder.jaudiotagger.audio.asf.data.AudioStreamChunk;
import com.shabinder.jaudiotagger.audio.asf.data.MetadataContainer;
import com.shabinder.jaudiotagger.audio.asf.data.MetadataDescriptor;
import com.shabinder.jaudiotagger.audio.asf.io.*;
import com.shabinder.jaudiotagger.audio.asf.util.TagConverter;
import com.shabinder.jaudiotagger.audio.asf.util.Utils;
...
import com.shabinder.jaudiotagger.tag.asf.AsfTag;
...
public class AsfFileReader extends AudioFileReader
{
     ...
     * Logger instance
     */
    private final static Logger LOGGER = Logger.getLogger("com.shabinder.jaudiotagger.audio.asf");
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileReader#getEncodingInfo(RandomAccessFile)
     */
    @Override
     ...
     * (overridden)
     *
     * @see com.shabinder.jaudiotagger.audio.generic.AudioFileReader#getTag(RandomAccessFile)
     */
    @Override
