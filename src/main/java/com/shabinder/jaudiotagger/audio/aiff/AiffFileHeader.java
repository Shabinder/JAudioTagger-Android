...
import static com.shabinder.jaudiotagger.audio.aiff.AiffType.AIFC;
import static com.shabinder.jaudiotagger.audio.aiff.AiffType.AIFF;
import static com.shabinder.jaudiotagger.audio.iff.IffHeaderChunk.HEADER_LENGTH;
import static com.shabinder.jaudiotagger.audio.iff.IffHeaderChunk.TYPE_LENGTH;
...
public class AiffFileHeader
{
    ...
    private static Logger logger = Logger.getLogger("com.shabinder.jaudiotagger.audio.aiff.AudioFileHeader");

    /**
     * Reads the file header and registers the data (file type) with the given header.
     *
     * @param fc random access file
     * @param aiffAudioHeader the {@link com.shabinder.jaudiotagger.audio.AudioHeader} we set the read data to
     * @param fileName
