...
import static com.shabinder.jaudiotagger.audio.dsf.DsdChunk.CHUNKSIZE_LENGTH;
...
{
    public static Logger logger = Logger.getLogger("com.shabinder.jaudiotagger.audio.dsf.FmtChunk");
     ...
     *                       fields
     * @return an empty {@link com.shabinder.jaudiotagger.audio.generic.GenericAudioHeader} if audioInfoChunk has less
