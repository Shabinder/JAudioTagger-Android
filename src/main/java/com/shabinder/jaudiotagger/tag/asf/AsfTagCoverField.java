package com.shabinder.jaudiotagger.tag.asf;
...
public class AsfTagCoverField extends AbstractAsfTagImageField
{
    ...
    public final static Logger LOGGER = Logger
            .getLogger("com.shabinder.jaudiotagger.audio.asf.tag");
    ...
    private byte[] createRawContent(final byte[] data, final int pictureType,
        ...
        // ImageDataSize
        baos.write(com.shabinder.jaudiotagger.audio.generic.Utils
    ...
    private void processRawContent() throws UnsupportedEncodingException {
        ...
        // ImageDataSize
        this.imageDataSize = com.shabinder.jaudiotagger.audio.generic.Utils.getIntLE(this
                .getRawContent(), 1, 2);
