...
import com.shabinder.jaudiotagger.tag.id3.framebody.FrameBodyEncrypted;
...
public abstract class AbstractID3v2Frame extends AbstractTagFrame implements TagTextField
{
    ...
    public AbstractID3v2Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.shabinder.jaudiotagger.tag.id3.framebody.FrameBody" + identifier);
